...
public class ClientDAO {
   ...
   // CREATE
    public void addClient(ClientModel client) {
        ...
        try (PreparedStatement ps = connection.prepareStatement(sql)) {            ps.setString(1, client.getNom());            ps.setString(2, client.getPrenom());            ps.setString(3, client.getEmail());            ps.setString(4, client.getTelephone());            ps.executeUpdate();        } catch (SQLException e)             e.printStackTrace();            }    // READ     public List<ClientModel> getAllClients() {
